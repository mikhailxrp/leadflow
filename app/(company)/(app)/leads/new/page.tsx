    ...
    <>
      <header
        className="
          ...
          border-b-[0.5px] border-[var(--color-border)] bg-[var(--color-bg-surface)] px-4 sm:px-6
        "
      >
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          <nav
            ...
            className="flex min-w-0 items-center gap-2 text-[17px] sm:text-[20px]"
          >
            <Link
              href="/leads"
            ...
            <span className="truncate font-medium text-[var(--color-text-primary)]">Новый лид</span>
          </nav>
        </div>
