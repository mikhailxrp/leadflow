      ...
      <div className="flex flex-col gap-4">
        ...
        >
          ...
          <p
            ...
            "
          >
            <strong>Важно:</strong> по умолчанию Метрика сопоставляет офлайн-конверсию
            только в течение 16 часов после визита. Чтобы окно увеличилось до 21 дня,
            включите в самой Метрике («Настройка» → блок офлайн-конверсий) чекбокс
            «Увеличенный период учёта конверсий» — <strong>заранее</strong>, до
            накопления визитов: расширение не ретроактивно и не подхватывает визиты,
            случившиеся до включения чекбокса.
          </p>
        </div>
      </div>
