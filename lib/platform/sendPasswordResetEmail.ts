...
export async function sendPlatformPasswordResetEmail({
  ...
  const subject = 'Лид-Канал Platform: восстановление пароля';
  const text =
    `Вы запросили восстановление пароля для платформенного администратора Лид-Канал.\n\n` +
    `Перейдите по ссылке, чтобы задать новый пароль:\n${resetUrl}\n\n` +
    `Ссылка действует 1 час.\n` +
    `Если вы не запрашивали восстановление, просто проигнорируйте это письмо.`;

  const html = `
    <p>Вы запросили восстановление пароля для платформенного администратора Лид-Канал.</p>
    <p>
